...
$placesArr = $conn->query("SELECT id,name FROM places ORDER BY id")->fetch_all(MYSQLI_ASSOC);
...
<body>
  <main class="app" style="max-width:100%;background:#f1f5f9">
    ...
    <div id="add-quest-form" class="pg-card" style="display:none;margin-bottom:14px">
      ...
      <p style="font-size:12.5px;color:#94a3b8;margin:2px 0 0">ระบบสุ่มรหัส QR ให้อัตโนมัติ</p>
    ...
    <div class="search-box">
      ...
      <input type="text" id="quest-search" placeholder="ค้นหาชื่อภารกิจ / สถานที่ / ประเภท" oninput="filterQuests(this.value)">
    </div>

    <div class="pg-card" id="quests-list">
      <?php foreach ($quests as $q): ?>
      <div class="quest-group" data-search="<?= e(mb_strtolower($q["title"] . " " . $q["place_name"] . " " . $q["quest_type"], "UTF-8")) ?>">
        <div class="row-item">
          <div class="row-info">
